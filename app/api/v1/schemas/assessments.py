...
from app.services.utils.crud_utils import (
    fetch_existing_order_assessments,
...
class AssessmentCreate(BaseModel):
    ...
    def validate_existing_order_in_subject(self):
        ...
        if existing_assessment_order:
            raise ValueError(
                f"Order {order} is already assigned to another assessment in this subject."
            )
        return self
...
class AssessmentMinimal(BaseModel):
    id: int
    title: str
    subject: BaseSubjectFetch | None = None
