...
def upgrade() -> None:
    ...
    op.add_column('courses', sa.Column('objectives', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.add_column('courses', sa.Column('level', sa.Enum('BEGINNER', 'INTERMEDIATE', 'EXPERT', name='levelenum'), nullable=True))
