...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['achieved_by_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['achievement_type_id'], ['achievements.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_user_achievements_achieved_by_id'), 'user_achievements', ['achieved_by_id'], unique=False)
    op.create_index(op.f('ix_user_achievements_achievement_type_id'), 'user_achievements', ['achievement_type_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['streak_by_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['streak_type_id'], ['streak_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_user_streaks_id'), 'user_streaks', ['id'], unique=False)
    op.create_index(op.f('ix_user_streaks_streak_by_id'), 'user_streaks', ['streak_by_id'], unique=False)
    op.create_index(op.f('ix_user_streaks_streak_type_id'), 'user_streaks', ['streak_type_id'], unique=False)
    op.add_column('achievements', sa.Column('icon', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False))
    op.add_column('achievements', sa.Column('is_expirable', sa.Boolean(), nullable=False))
    op.add_column('achievements', sa.Column('is_active', sa.Boolean(), nullable=False))
    ...
    op.add_column('courses', sa.Column('description', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.create_index(op.f('ix_courses_id'), 'courses', ['id'], unique=False)
    op.create_index(op.f('ix_courses_instructor_id'), 'courses', ['instructor_id'], unique=False)
    op.add_column('profiles', sa.Column('avatar', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    ...
    op.create_index(op.f('ix_unit_contents_unit_id'), 'unit_contents', ['unit_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_contents_content_id'), 'user_contents', ['content_id'], unique=False)
    op.create_index(op.f('ix_user_contents_status'), 'user_contents', ['status'], unique=False)
    op.create_index(op.f('ix_user_contents_user_id'), 'user_contents', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_units_status'), 'user_units', ['status'], unique=False)
    op.create_index(op.f('ix_user_units_unit_id'), 'user_units', ['unit_id'], unique=False)
    op.create_index(op.f('ix_user_units_user_id'), 'user_units', ['user_id'], unique=False)
    op.drop_constraint(op.f('users_username_key'), 'users', type_='unique')
    op.create_index(op.f('ix_users_id'), 'users', ['id'], unique=False)
    op.create_index(op.f('ix_users_is_active'), 'users', ['is_active'], unique=False)
    op.create_index(op.f('ix_users_username'), 'users', ['username'], unique=True)
    op.create_index(op.f('ix_usersubject_status'), 'usersubject', ['status'], unique=False)
    op.create_index(op.f('ix_usersubject_subject_id'), 'usersubject', ['subject_id'], unique=False)
    op.create_index(op.f('ix_usersubject_user_id'), 'usersubject', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.add_column('achievements', sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
    op.add_column('achievements', sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
    ...
    op.drop_index(op.f('ix_user_achievements_achievement_type_id'), table_name='user_achievements')
    op.drop_index(op.f('ix_user_achievements_achieved_by_id'), table_name='user_achievements')
